...
# }}}
    def _section_mvent(self):# {{{
        ...
        collect.append('MVENT,68,32,20,V,0.4,0.36,V,0.4,0.36,0.66,200,300,TIME,,,0,1,0,1,0,0')
        collect.append('MVENT,68,32,21,V,0.4,0.25,V,0.4,0.25,2.18,200,300,TIME,,,0,1,0,1,0,0')
        collect.append('MVENT,68,65,22,V,0.4,0.14,V,0.4,0.14,0.36,200,300,TIME,,,0,1,0,1,0,0')
        collect.append('MVENT,68,64,23,V,0.4,0.49,V,0.4,0.49,2.50,200,300,TIME,,,0,1,0,1,0,0')
        collect.append('MVENT,68,61,24,V,0.4,0.06,V,0.4,0.06,0.31,200,300,TIME,,,0,1,0,1,0,0')
        collect.append('MVENT,68,49,25,V,0.4,0.36,V,0.4,0.36,0.69,200,300,TIME,,,0,1,0,1,0,0')
        collect.append('MVENT,68,30,26,V,0.4,0.14,V,0.4,0.14,0.31,200,300,TIME,,,0,1,0,1,0,0')
        collect.append('MVENT,68,28,27,V,0.4,0.24,V,0.4,0.24,1.08,200,300,TIME,,,0,1,0,1,0,0')
        collect.append('MVENT,68,47,28,V,0.4,0.36,V,0.4,0.36,1.08,200,300,TIME,,,0,1,0,1,0,0')
